...
import fr.celestgames.isoworlds.minesweeper.PerlinNoise;
...
public class Map implements Serializable {
    ...
    public static void save(Map map) throws IOException {
        FileOutputStream file = new FileOutputStream("src\\main\\resources\\fr\\celestgames\\isoworlds\\saves\\map.ser");
